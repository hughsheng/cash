...
/**
 * Created by sztangli on 2018-3-14.
 *
 */

public class FilterDialogAFragment extends DialogFragment implements View.OnClickListener{

  public static final String TAG = "SearchVoiceDialogFragme";
  private FilterDialogAFragmentListener listener;
  private View view;
  private RadioGroup rp1, rp2, rp3, rp4;


  public static FilterDialogAFragment newInstance() {
    return new FilterDialogAFragment();
  }

  @Override
  public void onAttach(Context context) {
    super.onAttach(context);
    listener = (FilterDialogAFragmentListener) context;
  }
  ...
  public interface FilterDialogAFragmentListener {
